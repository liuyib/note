...
- 修改人家贡献的 PR（不是先合并再修改）
  ...
  - **PR** 和**提出 PR 的分支**关联、同步着，所以修改分支后，PR 就会自动更新

  如果你觉着他人贡献的 PR 有问题，做了修改，并且想把你的 commit 追加到这个 PR 上。那么，你只需要将你的 commit 提交到他人 Fork 你的仓库副本中即可（你对他人 Fork 你的仓库副本具有控制权力）
  ...
  # 将你的修改推送到仓库副本中
  $ git push --set-upstream liuyib patch-1
  ```
